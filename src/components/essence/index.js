      ...
      <Styled.Container>
        ...
        <Styled.BoxInformation>
          ...
          <p>
            ...
            Backoffice do negócio, dando maior possibilidade aos empreendedores
            de atuarem com o que realmente seja o objetivo do empreendimento.
          </p>
        </Styled.BoxInformation>
        <Styled.BoxInformation>
          <FaUsers/>
          ...
          <p>
            Unidade de Negócio focada na instrução, formação e gerenciamento de
            campanhas políticas. Tendo como principal objetivo o direcionamento
            estratégico e o engajamento de lideranças locais no processo
            políticio nacional.
          </p>
        </Styled.BoxInformation>
      </Styled.Container>
